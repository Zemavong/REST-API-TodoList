...
import (
	...
	TodoList "github.com/zemavong/TodoList"
)
...
func (m *MockAuthorization) CreateUser(user TodoList.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Create(userId int, list TodoList.Todo) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) GetAll(userId int) ([]TodoList.Todo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId)
	ret0, _ := ret[0].([]TodoList.Todo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTodoList) GetById(userId, listId int) (TodoList.Todo, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Update(userId, listId int, input TodoList.UpdateListInput) error {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockTodoItem) Create(userId, listId int, item TodoList.TodoItem) (int, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockTodoItem) GetAll(userId, listId int) ([]TodoList.TodoItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId, listId)
	ret0, _ := ret[0].([]TodoList.TodoItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetById mocks base method.
func (m *MockTodoItem) GetById(userId, itemId int) (TodoList.TodoItem, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, input TodoList.UpdateItemInput) error {
	m.ctrl.T.Helper()
